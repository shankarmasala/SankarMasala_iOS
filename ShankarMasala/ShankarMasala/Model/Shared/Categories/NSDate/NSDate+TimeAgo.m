...
- (NSString *)timeAgo
{
    ...
    if ([self timeIntervalSinceDate:now] > 0) {
        // Our code
        // fuature
        ...
        {
            return [self stringFromFormat:@"%%d %@seconds later" withValue:deltaSeconds];
        }
        else if(deltaSeconds < 120)
        {
            return NSDateTimeAgoLocalizedStrings(@"A minute later");
        }
        else if (deltaMinutes < 60)
        {
            return [self stringFromFormat:@"%%d %@minutes later" withValue:deltaMinutes];
        }
        else if (deltaMinutes < 120)
        {
            return NSDateTimeAgoLocalizedStrings(@"An hour later");
        }
        else if (deltaMinutes < (24 * 60))
        {
            minutes = (int)floor(deltaMinutes/60);
            return [self stringFromFormat:@"%%d %@hours later" withValue:minutes];
        }
        ...
        else if (deltaMinutes < (24 * 60 * 7))
        {
            ...
            return [self stringFromFormat:@"%%d %@days later" withValue:minutes];
        }
        ...
        else if (deltaMinutes < (24 * 60 * 31))
        {
            ...
            return [self stringFromFormat:@"%%d %@weeks later" withValue:minutes];
        }
        ...
        else if (deltaMinutes < (24 * 60 * 365.25))
        {
            ...
            return [self stringFromFormat:@"%%d %@months later" withValue:minutes];
        }
        ...
        return [self stringFromFormat:@"%%d %@years later" withValue:minutes];
